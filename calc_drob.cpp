...
do{ 
    printf("Ââåäèòå ÷èñëèòåëü äëÿ ïåðâîé äðîáè ="); 
    scanf("%d",&ch11); 
...
do{ 
    printf("Ââåäèòå çíàìåíàòåëü äëÿ ïåðâîé äðîáè =");
    scanf("%d",&zn11); 
...
do{ 
    printf("Ââåäèòå ÷èñëèòåëü äëÿ âòîðîé äðîáè =");
    scanf("%d",&ch22); 
...
do{ 
    printf("Ââåäèòå çíàìåíàòåëü äëÿ âòîðîé äðîáè =");
    scanf("%d",&zn22); 
...
while (1);
	...
	if((ch22<0) && (zn22<0)){
     ...
     do{
		...
		vivod1(ch22,zn22);
		setlocale(LC_ALL,"RUS");
		printf("\n\nÅñëè õîòèòå ñäåëàòü ïëþñ íàæìèòå - 1");
	    printf("\nÅñëè õîòèòå ñäåëàòü ìèíóñ íàæìèòå - 2");
	    printf("\nÅñëè õîòèòå ñäåëàòü óìíîæåíèå íàæìèòå - 3");
	    printf("\nÅñëè õîòèòå ñäåëàòü äåëåíèå íàæìèòå íà - 4");
		printf("\n   Ââåäèòå ñâîé âûáîð -- ");
		...
		setlocale(LC_ALL,"RUS");
		printf("\n\n\nÅñëè õîòèòå âûáðàòü ÷òî òî äðóãîå ââåäèòå 1 - ");
		setlocale(LC_ALL,"C");
		scanf("%d",&povt);
	if (povt !=1) break;
      system("cls");  } 
